...
{
    partial class FrmRaporlamaForm
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.personelDataSet = new PersonelKayıt_VeriTabanı.PersonelDataSet();
            this.personelDataSetBindingSource = new System.Windows.Forms.BindingSource(this.components);
            this.tblPersonelBindingSource = new System.Windows.Forms.BindingSource(this.components);
            this.tbl_PersonelTableAdapter = new PersonelKayıt_VeriTabanı.PersonelDataSetTableAdapters.Tbl_PersonelTableAdapter();
            ...
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "PersonelKayıt_VeriTabanı.Report1.rdlc";
            ...
            this.tblPersonelBindingSource.DataSource = this.personelDataSetBindingSource;
            // 
            ...
            this.Name = "FrmRaporlamaForm";
            this.Text = "FrmRaporlamaForm";
            this.Load += new System.EventHandler(this.FrmRaporlamaForm_Load);
